...
public partial class D_TileCardData : BGEntity
{
	...
	private static readonly D_SkillData.Factory _factory44_PFS = new D_SkillData.Factory();
	private static readonly D_U_CurrencyData.Factory _factory45_PFS = new D_U_CurrencyData.Factory();
...
public partial class D_UnitData : BGEntity
{
	...
	public D_UnitAppearanceData f_unitAppearanceData
	{
		get => (D_UnitAppearanceData) _f_unitAppearanceData[Index];
		set => _f_unitAppearanceData[Index] = value;
	}
	public AnimControllerType f_animControllerType
	{
...
public partial class D_StageData : BGEntity
{
	...
	public static class __Names
	{
		...
		public const string EpisodeKey = "EpisodeKey";
	}
	private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
	...
	private static BansheeGz.BGDatabase.BGKey _edeht3sdad33_EpisodeKey;
	public static BansheeGz.BGDatabase.BGKey _EpisodeKey => _edeht3sdad33_EpisodeKey ?? (_edeht3sdad33_EpisodeKey = BGCodeGenUtils.GetKey(MetaDefault, new BGId(5058754559081058665UL, 11217876927748581538UL), () => _edeht3sdad33_EpisodeKey = null));
	private static readonly D_TileCardData.Factory _factory0_PFS = new D_TileCardData.Factory();
	private static readonly D_LocalUserData.Factory _factory1_PFS = new D_LocalUserData.Factory();
	private static readonly D_UnitData.Factory _factory2_PFS = new D_UnitData.Factory();
	private static readonly D_unitBuildData.Factory _factory3_PFS = new D_unitBuildData.Factory();
	...
	public static D_StageData GetEntityByKeyEpisodeKey(D_EpisodeData EpisodeData) => (D_StageData) _EpisodeKey.GetEntityByKey<D_EpisodeData>(EpisodeData);
	public static List<D_StageData> GetEntitiesByKeyEpisodeKey(D_EpisodeData EpisodeData, List<D_StageData> result=null) => _EpisodeKey.GetEntitiesByKey<D_StageData, D_EpisodeData>(result, EpisodeData);
}
...
public partial class D_RelicItemExpData : BGEntity
{

	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta) => new D_RelicItemExpData(meta);
		public BGEntity NewEntity(BGMetaEntity meta, BGId id) => new D_RelicItemExpData(meta, id);
	}

	public static class __Names
	{
		public const string Meta = "RelicItemExpData";
		public const string name = "name";
		public const string level = "level";
		public const string maxExp = "maxExp";
	}
	private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaRow MetaDefault => _metaDefault ?? (_metaDefault = BGCodeGenUtils.GetMeta<BansheeGz.BGDatabase.BGMetaRow>(new BGId(5515192234944454563UL,17160252741212904832UL), () => _metaDefault = null));
	public static BansheeGz.BGDatabase.BGRepoEvents Events => BGRepo.I.Events;
	public static int CountEntities => MetaDefault.CountEntities;
	public System.String f_name
	{
	...
	public System.Int32 f_maxExp
	{
		get => _f_maxExp[Index];
		set => _f_maxExp[Index] = value;
	}
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name => _ufle12jhs77_f_name ?? (_ufle12jhs77_f_name = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEntityName>(MetaDefault, new BGId(4939589315853417394UL, 11661696566390382737UL), () => _ufle12jhs77_f_name = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_level;
	public static BansheeGz.BGDatabase.BGFieldInt _f_level => _ufle12jhs77_f_level ?? (_ufle12jhs77_f_level = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5018920643124974935UL, 5547749632024863625UL), () => _ufle12jhs77_f_level = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_maxExp;
	public static BansheeGz.BGDatabase.BGFieldInt _f_maxExp => _ufle12jhs77_f_maxExp ?? (_ufle12jhs77_f_maxExp = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5030660059407657646UL, 11904441649879609790UL), () => _ufle12jhs77_f_maxExp = null));
	private static readonly D_TileCardData.Factory _factory0_PFS = new D_TileCardData.Factory();
	private static readonly D_LocalUserData.Factory _factory1_PFS = new D_LocalUserData.Factory();
	private static readonly D_UnitData.Factory _factory2_PFS = new D_UnitData.Factory();
	private static readonly D_unitBuildData.Factory _factory3_PFS = new D_unitBuildData.Factory();
	...
	private D_RelicItemExpData(BGMetaEntity meta, BGId id) : base(meta, id) {}
	public static D_RelicItemExpData FindEntity(Predicate<D_RelicItemExpData> filter) => BGCodeGenUtils.FindEntity(MetaDefault, filter);
	public static List<D_RelicItemExpData> FindEntities(Predicate<D_RelicItemExpData> filter, List<D_RelicItemExpData> result=null, Comparison<D_RelicItemExpData> sort=null) => BGCodeGenUtils.FindEntities(MetaDefault, filter, result, sort);
	public static void ForEachEntity(Action<D_RelicItemExpData> action, Predicate<D_RelicItemExpData> filter=null, Comparison<D_RelicItemExpData> sort=null) => BGCodeGenUtils.ForEachEntity(MetaDefault, action, filter, sort);
	public static D_RelicItemExpData GetEntity(BGId entityId) => (D_RelicItemExpData) MetaDefault.GetEntity(entityId);
	public static D_RelicItemExpData GetEntity(int index) => (D_RelicItemExpData) MetaDefault[index];
	public static D_RelicItemExpData GetEntity(string entityName) => (D_RelicItemExpData) MetaDefault.GetEntity(entityName);
	public static D_RelicItemExpData NewEntity() => (D_RelicItemExpData) MetaDefault.NewEntity();
	public static D_RelicItemExpData NewEntity(BGId entityId) => (D_RelicItemExpData) MetaDefault.NewEntity(entityId);
	public static D_RelicItemExpData NewEntity(Action<D_RelicItemExpData> callback) => (D_RelicItemExpData) MetaDefault.NewEntity(new BGMetaEntity.NewEntityContext(entity => callback((D_RelicItemExpData)entity)));
}

public partial class D_U_RelicData : BGEntity
{

	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta) => new D_U_RelicData(meta);
		public BGEntity NewEntity(BGMetaEntity meta, BGId id) => new D_U_RelicData(meta, id);
	}

	public static class __Names
	{
		public const string Meta = "U_RelicData";
		public const string name = "name";
		public const string relicData = "relicData";
		public const string isEquiped = "isEquiped";
		public const string equipedSlotIndex = "equipedSlotIndex";
		public const string level = "level";
		public const string exp = "exp";
	}
	private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaRow MetaDefault => _metaDefault ?? (_metaDefault = BGCodeGenUtils.GetMeta<BansheeGz.BGDatabase.BGMetaRow>(new BGId(5307488886618257461UL,10451565033052198813UL), () => _metaDefault = null));
	public static BansheeGz.BGDatabase.BGRepoEvents Events => BGRepo.I.Events;
	public static int CountEntities => MetaDefault.CountEntities;
	public System.String f_name
	{
	...
	public D_RelicItemData f_relicData
	{
		get => (D_RelicItemData) _f_relicData[Index];
		set => _f_relicData[Index] = value;
	}
	public System.Boolean f_isEquiped
	{
		get => _f_isEquiped[Index];
		set => _f_isEquiped[Index] = value;
	}
	public System.Int32 f_equipedSlotIndex
	{
		get => _f_equipedSlotIndex[Index];
		set => _f_equipedSlotIndex[Index] = value;
	}
	public System.Int32 f_level
	{
		get => _f_level[Index];
	...
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name => _ufle12jhs77_f_name ?? (_ufle12jhs77_f_name = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEntityName>(MetaDefault, new BGId(5317679768039618586UL, 9274888376259556487UL), () => _ufle12jhs77_f_name = null));
	private static BansheeGz.BGDatabase.BGFieldRelationSingle _ufle12jhs77_f_relicData;
	public static BansheeGz.BGDatabase.BGFieldRelationSingle _f_relicData => _ufle12jhs77_f_relicData ?? (_ufle12jhs77_f_relicData = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldRelationSingle>(MetaDefault, new BGId(4783142658430925841UL, 9525933392892939910UL), () => _ufle12jhs77_f_relicData = null));
	private static BansheeGz.BGDatabase.BGFieldBool _ufle12jhs77_f_isEquiped;
	public static BansheeGz.BGDatabase.BGFieldBool _f_isEquiped => _ufle12jhs77_f_isEquiped ?? (_ufle12jhs77_f_isEquiped = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldBool>(MetaDefault, new BGId(4648568504085768521UL, 91410889721365944UL), () => _ufle12jhs77_f_isEquiped = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_equipedSlotIndex;
	public static BansheeGz.BGDatabase.BGFieldInt _f_equipedSlotIndex => _ufle12jhs77_f_equipedSlotIndex ?? (_ufle12jhs77_f_equipedSlotIndex = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5049375018484361911UL, 5280237730855620799UL), () => _ufle12jhs77_f_equipedSlotIndex = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_level;
	public static BansheeGz.BGDatabase.BGFieldInt _f_level => _ufle12jhs77_f_level ?? (_ufle12jhs77_f_level = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(4620473912134512234UL, 1182561751706202282UL), () => _ufle12jhs77_f_level = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_exp;
	public static BansheeGz.BGDatabase.BGFieldInt _f_exp => _ufle12jhs77_f_exp ?? (_ufle12jhs77_f_exp = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5553277077171819972UL, 11492006269093443971UL), () => _ufle12jhs77_f_exp = null));
	private static readonly D_TileCardData.Factory _factory0_PFS = new D_TileCardData.Factory();
	private static readonly D_LocalUserData.Factory _factory1_PFS = new D_LocalUserData.Factory();
	private static readonly D_UnitData.Factory _factory2_PFS = new D_UnitData.Factory();
	private static readonly D_unitBuildData.Factory _factory3_PFS = new D_unitBuildData.Factory();
	...
	private D_U_RelicData(BGMetaEntity meta, BGId id) : base(meta, id) {}
	public static D_U_RelicData FindEntity(Predicate<D_U_RelicData> filter) => BGCodeGenUtils.FindEntity(MetaDefault, filter);
	public static List<D_U_RelicData> FindEntities(Predicate<D_U_RelicData> filter, List<D_U_RelicData> result=null, Comparison<D_U_RelicData> sort=null) => BGCodeGenUtils.FindEntities(MetaDefault, filter, result, sort);
	public static void ForEachEntity(Action<D_U_RelicData> action, Predicate<D_U_RelicData> filter=null, Comparison<D_U_RelicData> sort=null) => BGCodeGenUtils.ForEachEntity(MetaDefault, action, filter, sort);
	public static D_U_RelicData GetEntity(BGId entityId) => (D_U_RelicData) MetaDefault.GetEntity(entityId);
	public static D_U_RelicData GetEntity(int index) => (D_U_RelicData) MetaDefault[index];
	public static D_U_RelicData GetEntity(string entityName) => (D_U_RelicData) MetaDefault.GetEntity(entityName);
...
public partial class D_SkillData : BGEntity
{

	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta) => new D_SkillData(meta);
		public BGEntity NewEntity(BGMetaEntity meta, BGId id) => new D_SkillData(meta, id);
	}

	public static class __Names
	{
		public const string Meta = "SkillData";
		public const string name = "name";
	...
	public System.Int32 f_initalSize
	{
		get => _f_initalSize[Index];
		set => _f_initalSize[Index] = value;
	}
	public System.String f_addressableKey
	{
		get => _f_addressableKey[Index];
	...
	private static readonly D_SkillData.Factory _factory44_PFS = new D_SkillData.Factory();
	private static readonly D_U_CurrencyData.Factory _factory45_PFS = new D_U_CurrencyData.Factory();
	private D_SkillData() : base(MetaDefault) {}
	private D_SkillData(BGId id) : base(MetaDefault, id) {}
	private D_SkillData(BGMetaEntity meta) : base(meta) {}
	private D_SkillData(BGMetaEntity meta, BGId id) : base(meta, id) {}
	public static D_SkillData FindEntity(Predicate<D_SkillData> filter) => BGCodeGenUtils.FindEntity(MetaDefault, filter);
	public static List<D_SkillData> FindEntities(Predicate<D_SkillData> filter, List<D_SkillData> result=null, Comparison<D_SkillData> sort=null) => BGCodeGenUtils.FindEntities(MetaDefault, filter, result, sort);
	public static void ForEachEntity(Action<D_SkillData> action, Predicate<D_SkillData> filter=null, Comparison<D_SkillData> sort=null) => BGCodeGenUtils.ForEachEntity(MetaDefault, action, filter, sort);
	public static D_SkillData GetEntity(BGId entityId) => (D_SkillData) MetaDefault.GetEntity(entityId);
	public static D_SkillData GetEntity(int index) => (D_SkillData) MetaDefault[index];
	public static D_SkillData GetEntity(string entityName) => (D_SkillData) MetaDefault.GetEntity(entityName);
	public static D_SkillData NewEntity() => (D_SkillData) MetaDefault.NewEntity();
	public static D_SkillData NewEntity(BGId entityId) => (D_SkillData) MetaDefault.NewEntity(entityId);
	public static D_SkillData NewEntity(Action<D_SkillData> callback) => (D_SkillData) MetaDefault.NewEntity(new BGMetaEntity.NewEntityContext(entity => callback((D_SkillData)entity)));
}

public partial class D_U_CurrencyData : BGEntity
{

	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta) => new D_U_CurrencyData(meta);
		public BGEntity NewEntity(BGMetaEntity meta, BGId id) => new D_U_CurrencyData(meta, id);
	}

	public static class __Names
	{
		public const string Meta = "U_CurrencyData";
		public const string name = "name";
	...
	private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaRow MetaDefault => _metaDefault ?? (_metaDefault = BGCodeGenUtils.GetMeta<BansheeGz.BGDatabase.BGMetaRow>(new BGId(5219453410366658982UL,2418118639796991422UL), () => _metaDefault = null));
	public static BansheeGz.BGDatabase.BGRepoEvents Events => BGRepo.I.Events;
	public static int CountEntities => MetaDefault.CountEntities;
	public System.String f_name
	{
	...
	public CurrencyType f_currencyType
	{
		get => (CurrencyType) _f_currencyType.GetStoredValue(Index);
		set => _f_currencyType.SetStoredValue(Index, (System.Int32) value);
	}
	public System.Int64 f_amount
	{
		get => _f_amount[Index];
		set => _f_amount[Index] = value;
	}
	public System.Int32 f_refreshTime
	{
		get => _f_refreshTime[Index];
		set => _f_refreshTime[Index] = value;
	}
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name => _ufle12jhs77_f_name ?? (_ufle12jhs77_f_name = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEntityName>(MetaDefault, new BGId(5111904611769647443UL, 14241155547327210428UL), () => _ufle12jhs77_f_name = null));
	private static BansheeGz.BGDatabase.BGFieldEnum _ufle12jhs77_f_currencyType;
	public static BansheeGz.BGDatabase.BGFieldEnum _f_currencyType => _ufle12jhs77_f_currencyType ?? (_ufle12jhs77_f_currencyType = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEnum>(MetaDefault, new BGId(5744210964606848719UL, 13968042001872045709UL), () => _ufle12jhs77_f_currencyType = null));
	private static BansheeGz.BGDatabase.BGFieldLong _ufle12jhs77_f_amount;
	public static BansheeGz.BGDatabase.BGFieldLong _f_amount => _ufle12jhs77_f_amount ?? (_ufle12jhs77_f_amount = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldLong>(MetaDefault, new BGId(5480477944828379913UL, 2909484208717399169UL), () => _ufle12jhs77_f_amount = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_refreshTime;
	public static BansheeGz.BGDatabase.BGFieldInt _f_refreshTime => _ufle12jhs77_f_refreshTime ?? (_ufle12jhs77_f_refreshTime = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5513582576779439685UL, 2119089607795633575UL), () => _ufle12jhs77_f_refreshTime = null));
	private static readonly D_TileCardData.Factory _factory0_PFS = new D_TileCardData.Factory();
	private static readonly D_LocalUserData.Factory _factory1_PFS = new D_LocalUserData.Factory();
	private static readonly D_UnitData.Factory _factory2_PFS = new D_UnitData.Factory();
	private static readonly D_unitBuildData.Factory _factory3_PFS = new D_unitBuildData.Factory();
	...
	private static readonly D_SkillData.Factory _factory44_PFS = new D_SkillData.Factory();
	private static readonly D_U_CurrencyData.Factory _factory45_PFS = new D_U_CurrencyData.Factory();
	private D_U_CurrencyData() : base(MetaDefault) {}
	private D_U_CurrencyData(BGId id) : base(MetaDefault, id) {}
	private D_U_CurrencyData(BGMetaEntity meta) : base(meta) {}
	private D_U_CurrencyData(BGMetaEntity meta, BGId id) : base(meta, id) {}
	public static D_U_CurrencyData FindEntity(Predicate<D_U_CurrencyData> filter) => BGCodeGenUtils.FindEntity(MetaDefault, filter);
	public static List<D_U_CurrencyData> FindEntities(Predicate<D_U_CurrencyData> filter, List<D_U_CurrencyData> result=null, Comparison<D_U_CurrencyData> sort=null) => BGCodeGenUtils.FindEntities(MetaDefault, filter, result, sort);
	public static void ForEachEntity(Action<D_U_CurrencyData> action, Predicate<D_U_CurrencyData> filter=null, Comparison<D_U_CurrencyData> sort=null) => BGCodeGenUtils.ForEachEntity(MetaDefault, action, filter, sort);
	public static D_U_CurrencyData GetEntity(BGId entityId) => (D_U_CurrencyData) MetaDefault.GetEntity(entityId);
	public static D_U_CurrencyData GetEntity(int index) => (D_U_CurrencyData) MetaDefault[index];
	public static D_U_CurrencyData GetEntity(string entityName) => (D_U_CurrencyData) MetaDefault.GetEntity(entityName);
	public static D_U_CurrencyData NewEntity() => (D_U_CurrencyData) MetaDefault.NewEntity();
	public static D_U_CurrencyData NewEntity(BGId entityId) => (D_U_CurrencyData) MetaDefault.NewEntity(entityId);
	public static D_U_CurrencyData NewEntity(Action<D_U_CurrencyData> callback) => (D_U_CurrencyData) MetaDefault.NewEntity(new BGMetaEntity.NewEntityContext(entity => callback((D_U_CurrencyData)entity)));
}
