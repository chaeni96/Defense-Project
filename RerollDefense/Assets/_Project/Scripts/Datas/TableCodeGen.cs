...
public partial class D_TileShpeData : BGEntity
{
	...
	private static readonly D_EnemyUnitData.Factory _factory11_PFS = new D_EnemyUnitData.Factory();
	private static readonly D_enemyGroup.Factory _factory12_PFS = new D_enemyGroup.Factory();
...
public partial class D_WaveData : BGEntity
{
	...
	public static BansheeGz.BGDatabase.BGFieldNested _f_enemyGroup => _ufle12jhs77_f_enemyGroup ?? (_ufle12jhs77_f_enemyGroup = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldNested>(MetaDefault, new BGId(5345308043117082884UL, 50824876378057116UL), () => _ufle12jhs77_f_enemyGroup = null));
...
public partial class D_EnemyUnitData : BGEntity
{

	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta) => new D_EnemyUnitData(meta);
		public BGEntity NewEntity(BGMetaEntity meta, BGId id) => new D_EnemyUnitData(meta, id);
	}

	public static class __Names
	{
		public const string Meta = "EnemyUnitData";
		public const string name = "name";
		public const string AddressableKey = "AddressableKey";
	}
	private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaRow MetaDefault => _metaDefault ?? (_metaDefault = BGCodeGenUtils.GetMeta<BansheeGz.BGDatabase.BGMetaRow>(new BGId(5662461308528904781UL,15842694670977998466UL), () => _metaDefault = null));
	public static BansheeGz.BGDatabase.BGRepoEvents Events => BGRepo.I.Events;
	public static int CountEntities => MetaDefault.CountEntities;
	public System.String f_name
	{
	...
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name => _ufle12jhs77_f_name ?? (_ufle12jhs77_f_name = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEntityName>(MetaDefault, new BGId(5624691818671414290UL, 16636242087198983552UL), () => _ufle12jhs77_f_name = null));
	private static BansheeGz.BGDatabase.BGFieldString _ufle12jhs77_f_AddressableKey;
	public static BansheeGz.BGDatabase.BGFieldString _f_AddressableKey => _ufle12jhs77_f_AddressableKey ?? (_ufle12jhs77_f_AddressableKey = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldString>(MetaDefault, new BGId(5250490465611470753UL, 10546988470911777703UL), () => _ufle12jhs77_f_AddressableKey = null));
	...
	private static readonly D_EnemyUnitData.Factory _factory11_PFS = new D_EnemyUnitData.Factory();
	private static readonly D_enemyGroup.Factory _factory12_PFS = new D_enemyGroup.Factory();
	private D_EnemyUnitData() : base(MetaDefault) {}
	private D_EnemyUnitData(BGId id) : base(MetaDefault, id) {}
	private D_EnemyUnitData(BGMetaEntity meta) : base(meta) {}
	private D_EnemyUnitData(BGMetaEntity meta, BGId id) : base(meta, id) {}
	public static D_EnemyUnitData FindEntity(Predicate<D_EnemyUnitData> filter) => BGCodeGenUtils.FindEntity(MetaDefault, filter);
	public static List<D_EnemyUnitData> FindEntities(Predicate<D_EnemyUnitData> filter, List<D_EnemyUnitData> result=null, Comparison<D_EnemyUnitData> sort=null) => BGCodeGenUtils.FindEntities(MetaDefault, filter, result, sort);
	public static void ForEachEntity(Action<D_EnemyUnitData> action, Predicate<D_EnemyUnitData> filter=null, Comparison<D_EnemyUnitData> sort=null) => BGCodeGenUtils.ForEachEntity(MetaDefault, action, filter, sort);
	public static D_EnemyUnitData GetEntity(BGId entityId) => (D_EnemyUnitData) MetaDefault.GetEntity(entityId);
	public static D_EnemyUnitData GetEntity(int index) => (D_EnemyUnitData) MetaDefault[index];
	public static D_EnemyUnitData GetEntity(string entityName) => (D_EnemyUnitData) MetaDefault.GetEntity(entityName);
	public static D_EnemyUnitData NewEntity() => (D_EnemyUnitData) MetaDefault.NewEntity();
	public static D_EnemyUnitData NewEntity(BGId entityId) => (D_EnemyUnitData) MetaDefault.NewEntity(entityId);
	public static D_EnemyUnitData NewEntity(Action<D_EnemyUnitData> callback) => (D_EnemyUnitData) MetaDefault.NewEntity(new BGMetaEntity.NewEntityContext(entity => callback((D_EnemyUnitData)entity)));
}
...
public partial class D_enemyGroup : BGEntity
{
	...
	private static BansheeGz.BGDatabase.BGMetaNested _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaNested MetaDefault => _metaDefault ?? (_metaDefault = BGCodeGenUtils.GetMeta<BansheeGz.BGDatabase.BGMetaNested>(new BGId(5679986824346585699UL,13519905948331417730UL), () => _metaDefault = null));
	public static BansheeGz.BGDatabase.BGRepoEvents Events => BGRepo.I.Events;
	public static int CountEntities => MetaDefault.CountEntities;
	public System.String f_name
	{
	...
	public D_EnemyUnitData f_enemy
	{
		get => (D_EnemyUnitData) _f_enemy[Index];
	...
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name => _ufle12jhs77_f_name ?? (_ufle12jhs77_f_name = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldEntityName>(MetaDefault, new BGId(5755710676876541884UL, 13508841948145326251UL), () => _ufle12jhs77_f_name = null));
	private static BansheeGz.BGDatabase.BGFieldRelationSingle _ufle12jhs77_f_WaveData;
	public static BansheeGz.BGDatabase.BGFieldRelationSingle _f_WaveData => _ufle12jhs77_f_WaveData ?? (_ufle12jhs77_f_WaveData = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldRelationSingle>(MetaDefault, new BGId(4633261718432517911UL, 12234996149008103349UL), () => _ufle12jhs77_f_WaveData = null));
	private static BansheeGz.BGDatabase.BGFieldRelationSingle _ufle12jhs77_f_enemy;
	public static BansheeGz.BGDatabase.BGFieldRelationSingle _f_enemy => _ufle12jhs77_f_enemy ?? (_ufle12jhs77_f_enemy = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldRelationSingle>(MetaDefault, new BGId(5596336542167869348UL, 7598368673186015659UL), () => _ufle12jhs77_f_enemy = null));
	private static BansheeGz.BGDatabase.BGFieldInt _ufle12jhs77_f_amount;
	public static BansheeGz.BGDatabase.BGFieldInt _f_amount => _ufle12jhs77_f_amount ?? (_ufle12jhs77_f_amount = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldInt>(MetaDefault, new BGId(5397025717433921748UL, 10695471317775448970UL), () => _ufle12jhs77_f_amount = null));
	private static BansheeGz.BGDatabase.BGFieldFloat _ufle12jhs77_f_startDelay;
	public static BansheeGz.BGDatabase.BGFieldFloat _f_startDelay => _ufle12jhs77_f_startDelay ?? (_ufle12jhs77_f_startDelay = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldFloat>(MetaDefault, new BGId(5024818976965878847UL, 15306710317533016992UL), () => _ufle12jhs77_f_startDelay = null));
	private static BansheeGz.BGDatabase.BGFieldFloat _ufle12jhs77_f_spawnInterval;
	public static BansheeGz.BGDatabase.BGFieldFloat _f_spawnInterval => _ufle12jhs77_f_spawnInterval ?? (_ufle12jhs77_f_spawnInterval = BGCodeGenUtils.GetField<BansheeGz.BGDatabase.BGFieldFloat>(MetaDefault, new BGId(4927163463741392558UL, 432969407872684720UL), () => _ufle12jhs77_f_spawnInterval = null));
	private static readonly D_TileShpeData.Factory _factory0_PFS = new D_TileShpeData.Factory();
	private static readonly D_LocalUserData.Factory _factory1_PFS = new D_LocalUserData.Factory();
	private static readonly D_BoostDeck.Factory _factory2_PFS = new D_BoostDeck.Factory();
	private static readonly D_UnitData.Factory _factory3_PFS = new D_UnitData.Factory();
